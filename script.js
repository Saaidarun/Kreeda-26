// ========================================
// Countdown Timer for Sports Day
// ========================================
(function () {
    // Sports Day: March 12, 2026 at 9:00 AM IST
    const eventDate = new Date('2026-03-12T05:00:00+05:30').getTime();
    ...
    function updateCountdown() {
        ...
        if (diff <= 0) {
            ...
            if (container) {
                container.querySelector('.countdown-title').textContent = '🎉 KREEDA\'26 is LIVE! 🎉';
                container.querySelector('.countdown-boxes').innerHTML =
                    '<span class="countdown-ended">The Sports Day has begun! 🏆</span>';
            }
            return;
        }
